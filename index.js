...
btnGetResult.addEventListener("click", () => {
    ...
    switch(userChoice) {
        case "red": resultText = "you seek power and control.";
        break;
        case "green": resultText = "you are a natural visionary, non-conformist, and problem-solver kind of individual.";
        break;
        case "blue": resultText = "you look for meaning and significance in life.";
        break;
        case "black": resultText = "you are a strong-willed, determined, confident, independent, risk-taker kind of individual.";
        break;
        case "yellow": resultText = "you are an optimistic, fun-loving, cheery, creative kind of individual.";
        break;
        case "pink": resultText = "you are a playful, fun, easy-going, smart, genuine child-like, social butterfly kind of individual.";
        break;
        case "other": resultText = "bit stupid innit";
        break;
    }
